...
public protocol HMSerializable {
    init(data: JSONDictionary)
}

public func <-- <T: HMSerializable>(inout instance: T?, dataObject: AnyObject?) -> T? {
...
public func <-- <T: HMSerializable>(inout array: [T]?, dataObject: AnyObject?) -> [T]? {
...
public func <-- <T: HMSerializable>(inout map: [String: T]?, dataObject: AnyObject?) -> [String: T]? {
...
public func <-- <T: HMSerializable>(inout instance: T?, dataString: String) -> T? {
...
public func <-- <T: HMSerializable>(inout array: [T]?, dataString: String) -> [T]? {
...
public func <-- <T: HMSerializable>(inout map: [String: T]?, dataString: String) -> [String:T]? {
